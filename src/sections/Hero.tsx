  ...
  return (
    <div className="py-32">
      <div className="container">
        ...
        <h1 className="font-serif text-white text-3xl text-center mt-8 tracking-wide">Building Exceptional User Experiences</h1>
        <p className="mt-4 text-center text-white/60"> Full Stack Developer</p>
